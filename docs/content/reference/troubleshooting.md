...
Most of these come down to network reality or how swapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

swapi rate-limits like any public site. swapi already paces
...
Where a surface is gated, swapi reads a cookie or token you supply
...
`swapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what swapi actually did
