...
// HTTP behaviour is covered in swapi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "swapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("swapi", "about")
	if err != nil || got.String() != "swapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want swapi://page/about", got.String(), err)
	}
}
